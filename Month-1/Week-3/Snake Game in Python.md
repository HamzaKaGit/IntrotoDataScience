Implemented the famous `Snake Game` in this Code! Learn also how Used the `Curses Module` to build Terminal Applications. This Code is aimed at beginners. You will learn about different data structures Like:
* Lists.
* Tuples.
##### How to implement the game logic with different `Control Flows` Using:
* While loop 
* If-statements
````python
import curses 
